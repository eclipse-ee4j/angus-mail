...
Jakarta Mail 2.1.0 release provides an API jar file only and
the implementation is no longer part of this project. a bug fix release of the Jakarta Mail project
